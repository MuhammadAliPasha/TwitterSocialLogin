package com.twittersociallogin.activity;
...
import com.twittersociallogin.R;
import com.twittersociallogin.util.AlertDialogManager;
import com.twittersociallogin.util.ConnectionDetector;
...
public class MainActivity extends Activity {
        ...
        btnUpdateStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (status.trim().length() > 0) {
                    // update status
                    new TwitterStatusUpdateTask().execute(status);
                } else {
                    // EditText is empty
    ...
    private class TwitterGetAccessTokenTask extends AsyncTask<String, Void, User> {
     ...
     * */
    private class TwitterStatusUpdateTask extends AsyncTask<String, String, String> {
